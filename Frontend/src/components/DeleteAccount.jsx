...
function DeleteAccount({ user }) {
  ...
  useEffect(() => {
    ...
    <div className="flex justify-center">
      <button
        className="publish-comment text-white font-bold py-1 px-4 rounded bg-purple-500 hover:bg-purple-600 hover:border-purple-900 hover:border-opacity-100 hover:border-2"
        style={{
          fontSize: "1rem",
        }}
        onClick={handleDelete}
